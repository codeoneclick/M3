...
class HEXMAP_API UM3ViewActionsComponent : public UActorComponent {
...
class HEXMAP_API UM3Action : public UObject {
...
UCLASS(Blueprintable, BlueprintType, ClassGroup = (M3Actions))
class HEXMAP_API UM3Sequence : public UM3Action {
...
UCLASS(Blueprintable, BlueprintType, ClassGroup = (M3Actions))
class HEXMAP_API UM3MoveToAction : public UM3Action {
...
UCLASS(Blueprintable, BlueprintType, ClassGroup = (M3Actions))
class HEXMAP_API UM3ScaleToAction : public UM3Action {
...
UCLASS(Blueprintable, BlueprintType, ClassGroup = (M3Actions))
class HEXMAP_API UM3CallbackAction : public UM3Action {
