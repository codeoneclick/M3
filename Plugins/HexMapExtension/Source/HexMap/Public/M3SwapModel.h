...
class HEXMAP_API M3PotentialSwapEntity : public M3Entity {
public:
...
class HEXMAP_API M3PotentialSwapModel : public M3Model<M3PotentialSwapEntity> {
public:
...
class HEXMAP_API M3SwapEntity : public M3Entity {
public:
...
class HEXMAP_API M3SwapModel : public M3Model<M3SwapEntity> {
private:
